 ...
 */
public class EditionFragment extends ResultFragment {
    ...
    private void observe() {
        model.getFirstNumber().observe(this, integer -> {
            if (integer != null){
                firstNumber = integer;
                result.setText(String.valueOf(firstNumber + secondNumber));
            }
        });
        model.getSecondNumber().observe(this, integer -> {
            if (integer != null){
    ...
    private void init(View view) {
        result = view.findViewById(R.id.edition_result);
    }
}
